...
(function () {
  ...
  var P = {
    ...
    layout: { no: "", label: "Vào hệ thống · Bố cục chung" },
    ...
    pc: { no: "5", label: "Tính giá Pc · PH-009 / PH-008" },
    calc: { no: "6", label: "Tính toán và tổng hợp · PH-003" },
  ...
  var SLIDES = [
    ...
    // ---- 2. Sơ đồ chức năng ----
    {
      ...
      lead: "Hệ thống gồm <b>8 phân hệ</b>: <b>6 phân hệ nghiệp vụ</b> thể hiện luồng tính toán và lập hồ sơ, và <b>2 phân hệ quản trị & giám sát</b> phục vụ vận hành.",
    ...
    // ---- 3. Thu thập dữ liệu ----
    {
      ...
      lead: "Ngay sau đăng nhập, chuyên viên vào <b>Welcome page</b>: hiển thị các mô-đun của hệ thống và thấy ngay tổng quan kỳ tính toán.",
      bullets: [
        "<b>Module launcher</b>: 8 mô-đun của hệ thống, mở thẳng phân hệ cần làm.",
        "Hiển thị Tổng quan: cảnh báo, tiến độ, trạng thái đồng bộ ...",
        "Hiển thị ngay <b>nhà máy phụ trách</b> và <b>kỳ thanh toán</b> đang làm.",
      ],
      img: "welcome.png",
      caption: "Trang chào sau đăng nhập (SC-021)",
...

    {
      type: "content",
      part: P.layout,
      title: "Bố cục chung & luồng truy cập chức năng",
      lead: "Mọi phân hệ dùng chung một bố cục: menu chức năng bên trái, thanh header chọn <b>nhà máy</b> và <b>tháng hồ sơ</b> ở trên cùng.",
      bullets: [
        "Header luôn có <b>bộ chọn nhà máy</b> và <b>bộ chọn tháng hồ sơ</b> - xác định ngữ cảnh làm việc.",
        "Luồng truy cập chức năng: <b>Chọn nhà máy &rarr; chọn tháng &rarr; vào chức năng chi tiết</b>.",
        "Hệ thống <b>mặc định chọn tháng mới nhất</b>; chuyên viên chỉ đổi khi cần xem kỳ cũ.",
        "Mọi số liệu, tính toán và hồ sơ trên màn đều gắn theo <b>nhà máy + tháng</b> đang chọn.",
      ],
      img: "layout-chung.png",
      caption: "Bố cục chung: header chọn nhà máy + tháng hồ sơ (SC-015)",
      note: "Bộ chọn tháng hồ sơ trên header theo Biên bản 03; nhà máy chuẩn của bản trình bày là Phú Mỹ 1.",
      source: "SC-015, BB-03",
    },

    {
      ...
      img: "thu-thap.png",
      caption: "Thu thập & đồng bộ dữ liệu (SC-002)",
...

    {
      type: "content",
      part: P.collect,
      title: "Xem nhanh dữ liệu thô đã thu thập",
      lead: "Tab <b>Dữ liệu</b> cho xem trực tiếp số liệu thô mới nhất theo từng nguồn - nắm ngay hiện trạng dữ liệu đã thu thập.",
      bullets: [
        "Xem <b>dữ liệu thô</b> mới nhất theo nguồn / kỳ ngay trong hệ thống.",
        "<b>Tải xuống</b> dữ liệu để đối chiếu hoặc xử lý ngoài.",
        "Nắm hiện trạng dữ liệu để <b>truy vấn từ phần mềm / hệ thống khác</b> khi cần.",
      ],
      img: "thu-thap-dulieu.png",
      caption: "Tab Dữ liệu - số liệu thô đã thu thập (SC-002)",
      source: "SC-002",
    },

    {
      ...
      img: "thu-thap-ocr.png",
      caption: "Kiểm tra kết quả OCR trước khi xác nhận",
    ...
    // ---- 4. Sự kiện ----
    {
      ...
      img: "su-kien.png",
      caption: "Tổng hợp & công bố sự kiện (SC-003)",
...

    {
      ...
      img: "su-kien.png",
      caption: "Màn Sự kiện - các thao tác công bố / xử lý",
      source: "FL-004, FL-016, FL-017",
    },

    // ---- 5. Tính giá Pc (core, sâu nhất) ----
    {
      type: "content",
      part: P.pc,
      core: true,
      ...
      img: "pc-dau-vao.png",
      caption: "Tab Dữ liệu đầu vào - hai chiều tra cứu (SC-019)",
...

    {
      ...
      part: P.pc,
      core: true,
      title: "Pc - Bộ công thức áp dụng trong kỳ",
      lead: "Hệ thống tự xác định công thức <b>có hiệu lực tại kỳ đang tính</b>",
      bullets: [
        "Mỗi công thức kèm <b>hiệu lực từ / đến</b> và <b>căn cứ hợp đồng</b>",
        "Không ảnh hưởng tính toán kỳ cũ",
        "Trường hợp không có hoặc nhiều hơn 1 công thức thì sẽ <b>chặn tính</b> và đưa ra cảnh báo",
      ],
      img: "pc-cong-thuc.png",
      caption: "Tab Công thức áp dụng trong kỳ (chỉ đọc)",
...

    {
      ...
      bullets: [
        ...
        "Phù hợp thao tác tuần tự và kiểm tra từng bước.",
      ],
      img: "pc-quy-trinh.png",
      caption: "Tab Quy trình tính toán - bảng bước tính",
      source: "SC-019",
    },

    {
      ...
      img: "pc-ban-do.png",
      caption: "Bản đồ quy trình tính Pc (SC-020)",
      source: "SC-020",
    },

    {
      ...
      img: "pc-ban-do-node.png",
      caption: "Chọn một bước tính => panel chi tiết + đối chiếu",
...

    {
      ...
      part: P.pc,
      core: true,
      title: "Pc - Giải trình bảng tính",
      lead: "Mở file tính dưới dạng bảng tính để xem chi tiết từng con số.",
      bullets: [
        "File tính sẽ mở ở chế độ <b>read-only</b> (không cho phép s được).",
      ...
      img: "pc-audit.png",
      caption: "Giải trình audit dạng bảng tính (SC-016)",
      source: "SC-016",
    },

    {
      ...
      img: "cau-hinh-tinh-toan.png",
      caption: "Cấu hình tính toán (SC-018, PH-008)",
      source: "features/08, SC-018, DEC-013",
    },

    // ---- 6. Tính toán và tổng hợp ----
    {
      type: "content",
      part: P.calc,
      core: true,
      ...
      img: "tinh-toan.png",
      caption: "Tính toán và tổng hợp (SC-004)",
...

    {
      ...
      bullets: [
        ...
        "<b>So sánh giữa các lần tính</b> để thấy chênh lệch từng khoản.",
        "<b>Đối soát bảng kê thị trường</b> điện với số liệu hệ thống.",
      ],
      img: "tinh-toan.png",
      caption: "Kết quả theo khoản mục & so sánh giữa các lần tính",
    ...
    // ---- 7. Tổng hợp hồ sơ ----
    {
      ...
      bullets: [
        ...
        "Mọi kết quả vẫn <b>tính lại được</b> từ đầu vào đã lưu.",
...

    {
      ...
      img: "ho-so.png",
      caption: "Chi tiết hồ sơ thanh toán (SC-006)",
...

    {
      ...
      img: "ho-so-thu-muc.png",
      caption: "Thư mục hồ sơ - taxonomy 11 tài liệu (SC-014)",
...

    {
      ...
      img: "ho-so-xuat.png",
      caption: "Modal Xuất hồ sơ (SC-006)",
    ...
    // ---- 8. Báo cáo & cấu hình ----
    {
      ...
      img: "bao-cao.png",
      caption: "Giám sát và báo cáo (SC-007)",
...

    {
      ...
      img: "cau-hinh.png",
      caption: "Danh mục & cấu hình (SC-008)",
...

    {
      ...
      img: "themes.png",
      caption: "Đối chiếu phong cách giao diện (review-only)",
  ...
  function slideHTML(s, i) {
    ...
    if (s.type === "funcmap") {
      ...
      var funcol = function (g) {
        ...
        return (
          ...
          '<span class="funcol__no">' +
          esc(g.no) +
          "</span>" +
          '<span class="funcol__name">' +
          esc(g.name) +
          "</span>" +
          "</div>" +
          '<ul class="funcol__items">' +
          items +
          "</ul>" +
          "</div>"
        );
      ...
      var bands = (s.bands || [])
        .map(function (band) {
          ...
          return (
            '<section class="fband fband--' +
            (band.tone || "biz") +
            '" style="flex:' +
            (band.flex || 1) +
            '">' +
            '<header class="fband__label">' +
            esc(band.label) +
            "</header>" +
            '<div class="fband__cols">' +
            cols +
            "</div>" +
            "</section>"
          );
        ...
        .join("");
      var fmNote = s.note
        ? '<div class="note funcmap__note">' + s.note + "</div>"
        : "";
      return (
        '<section class="slide slide--funcmap" data-i="' +
        i +
        '">' +
        fmKicker +
        '<h1 class="slide__title">' +
        ...
        fmLead +
        '<div class="funcmap">' +
        '<div class="funcmap__root">' +
        esc(s.rootLabel || s.title) +
        "</div>" +
        '<div class="funcmap__stem"></div>' +
        '<div class="funcmap__bands">' +
        bands +
        "</div>" +
        "</div>" +
        fmNote +
    ...
    if (s.img) {
      figCol =
        '<div class="slide__fig"><div class="figure">' +
        '<div class="zoombar">' +
        ...
        "</div>" +
        (s.caption
          ? '<div class="figure__cap">' + esc(s.caption) + "</div>"
          : "") +
        "</div></div>";
    }
  ...
  document.addEventListener("keydown", function (e) {
    if (e.key === "ArrowRight" || e.key === "PageDown" || e.key === " ") {
      ...
      e.key === "Escape" &&
      gridOverlay.classList.contains("is-open")
    ) {
      toggleGrid();
    }
  });
  ...
  function buildThumbs() {
    ...
    Array.prototype.forEach.call(
      thumbsWrap.querySelectorAll(".thumb"),
      function (el) {
        el.onclick = function () {
          show(+el.getAttribute("data-i"));
          toggleGrid();
        };
      },
    );
  ...
  Array.prototype.forEach.call(
    deck.querySelectorAll(".figure"),
    function (fig) {
      var view = fig.querySelector(".figure__view");
      fig.querySelector('[data-z="in"]').onclick = function () {
        zoomBy(fig, Z.step);
      };
      fig.querySelector('[data-z="out"]').onclick = function () {
        zoomBy(fig, -Z.step);
      };
      fig.querySelector('[data-z="reset"]').onclick = function () {
        fig.__z = { s: 1, tx: 0, ty: 0 };
        applyZoom(fig);
      };
